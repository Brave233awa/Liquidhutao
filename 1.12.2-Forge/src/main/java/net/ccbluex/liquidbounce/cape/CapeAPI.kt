...
object CapeAPI : MinecraftInstance() {
    ...
    fun loadCape(uuid: UUID): CapeInfo? {
        ...
        val resourceLocation =
            LiquidBounce.wrapper.classProvider.createResourceLocation("capes/%s.png".format(uuid.toString()))
        val capeInfo = CapeInfo(resourceLocation)
        val threadDownloadImageData =
            LiquidBounce.wrapper.classProvider.createThreadDownloadImageData(null, url, null, object : WIImageBuffer {
