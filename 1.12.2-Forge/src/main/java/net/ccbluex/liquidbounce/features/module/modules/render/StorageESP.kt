        ...
        try {
            ...
            for (tileEntity in mc.theWorld!!.loadedTileEntityList) {
                val color: Color = when {
                    chestValue.get() && classProvider.isTileEntityChest(tileEntity) && !clickedBlocks.contains(
                        tileEntity.pos
                    ) -> Color(0, 66, 255)

                    enderChestValue.get() && classProvider.isTileEntityEnderChest(tileEntity) && !clickedBlocks.contains(
                        tileEntity.pos
                    ) -> Color.MAGENTA
                    ...
                    shulkerBoxValue.get() && classProvider.isTileEntityShulkerBox(tileEntity) -> Color(
                        0x6e,
                        0x4d,
                        0x6e
                    ).brighter()
