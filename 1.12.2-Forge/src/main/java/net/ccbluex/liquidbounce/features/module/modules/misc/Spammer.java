...
public class Spammer extends Module {
    ...
    private final TextValue messageValue = new TextValue("Message", LiquidBounce.CLIENT_NAME + " Client | liquidbounce(.net) | CCBlueX on yt");    private final IntegerValue maxDelayValue = new IntegerValue("MaxDelay", 1000, 0, 5000) {
        @Override
    ...
    private final BoolValue customValue = new BoolValue("Custom", false);    private final IntegerValue minDelayValue = new IntegerValue("MinDelay", 500, 0, 5000) {
