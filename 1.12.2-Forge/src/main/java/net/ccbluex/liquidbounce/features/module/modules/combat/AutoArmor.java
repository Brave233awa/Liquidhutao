...
public class AutoArmor extends Module {
    ...
    private final BoolValue invOpenValue = new BoolValue("InvOpen", false);    private final IntegerValue minDelayValue = new IntegerValue("MinDelay", 100, 0, 400) {
    ...
    private final BoolValue simulateInventory = new BoolValue("SimulateInventory", true);    private final IntegerValue maxDelayValue = new IntegerValue("MaxDelay", 200, 0, 400) {
        @Override
        protected void onChanged(final Integer oldValue, final Integer newValue) {
