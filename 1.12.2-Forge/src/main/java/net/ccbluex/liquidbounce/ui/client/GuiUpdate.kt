...
class GuiUpdate : WrappedGuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        Fonts.font35.drawCenteredString(
            "b${LiquidBounce.latestVersion} got released!",
            representedScreen.width / 2.0f,
            representedScreen.height / 8.0f + 80,
            0xffffff
        )
        Fonts.font35.drawCenteredString(
            "Press \"Download\" to visit our website or dismiss this message by pressing \"OK\".",
            representedScreen.width / 2.0f,
            representedScreen.height / 8.0f + 80 + Fonts.font35.fontHeight,
            0xffffff
        )
        ...
        Fonts.font35.drawCenteredString(
            ...
            representedScreen.height / 16.0f + 20,
            Color(255, 0, 0).rgb
        )
    }
