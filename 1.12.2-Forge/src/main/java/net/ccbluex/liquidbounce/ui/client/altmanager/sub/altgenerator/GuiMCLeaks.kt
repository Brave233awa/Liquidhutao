...
class GuiMCLeaks(private val prevGui: GuiAltManager) : WrappedGuiScreen() {
    ...
    override fun initGui() {
        ...
        // Token text field
        tokenField = classProvider.createGuiTextField(
            0,
            Fonts.font40,
            representedScreen.width / 2 - 100,
            representedScreen.height / 4 + 40,
            200,
            20
        )
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        Fonts.font40.drawString(
            "Token:",
            representedScreen.width / 2.0f - 100,
            representedScreen.height / 4.0f + 30,
            10526880
        )
