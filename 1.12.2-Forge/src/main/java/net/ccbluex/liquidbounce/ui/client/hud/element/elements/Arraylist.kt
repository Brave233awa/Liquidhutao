...
class Arraylist(
    ...
    override fun drawElement(): Border? {
        ...
        val alpha =
            Color(backgroundColorRedValue.get(), backgroundColorRedValue.get(), backgroundColorRedValue.get(), 150).rgb
        ...
        when (side.horizontal) {
            Horizontal.RIGHT, Horizontal.MIDDLE -> {
                modules.forEachIndexed { index, module ->
                    ...
                    val braibow = Color(
                        Rianbowr.get(),
                        col.getGreen() / 2 + Rianbowb.get(),
                        col.getGreen() / 2 + Rianbowb.get() + Rianbowg.get()
                    ).rgb
                    ...
                    RainbowShader.begin(
                        ...
                        RenderUtils.drawRect(
                            ...
                            module.higt + textHeight, when {
                                ...
                                backgroundColorMode.equals("ALLRainbow", ignoreCase = true) -> ColorUtils.ALLColor(
                                    400000000L * index
                                ).rgb

                                backgroundColorMode.equals("Bainbow", ignoreCase = true) -> braibow
                                backgroundColorMode.equals("TwoRainbow", ignoreCase = true) -> ColorUtils.TwoRainbow(
                                    400000000L * index,
                                    TwoRainbow.get()
                                ).rgb
                    ...
                    RainbowFontShader.begin(
                        ...
                        fontRenderer.drawString(
                            ...
                            when {
                                ...
                                colorMode.equals("OtherRainbow", ignoreCase = true) -> Colors.getRainbow(
                                    -2000,
                                    (yPos * 8.toFloat()).toInt()
                                )
                                ...
                                colorMode.equals(
                                    "ALLRainbow",
                                    ignoreCase = true
                                ) -> ColorUtils.ALLColor(400000000L * index).rgb

                                colorMode.equals("Bainbow", ignoreCase = true) -> braibow
                                colorMode.equals(
                                    "TwoRainbow",
                                    ignoreCase = true
                                ) -> ColorUtils.TwoRainbow(400000000L * index, TwoRainbow.get()).rgb
                    ...
                    if (!rectMode.equals("none", true)) {
                        ...
                        RainbowShader.begin(
                            ...
                            val rectColor = when {
                                ...
                                rectColorMode.equals("OtherRainbow", ignoreCase = true) -> Colors.getRainbow(
                                    -2000,
                                    (yPos * 8.toFloat()).toInt()
                                )
                                ...
                                rectColorMode.equals("TwoRainbow", ignoreCase = true) -> ColorUtils.TwoRainbow(
                                    400000000L * index,
                                    TwoRainbow.get()
                                ).rgb
                            ...
                            if (rectMode.equals("outline", true)) {
                                //左
                                RenderUtils.drawRect(
                                    xPos - 1 - backgroundwidth.get(),
                                    module.higt,
                                    xPos - 0 - backgroundwidth.get(),
                                    module.higt + textHeight + 0.5F,
                                    rectColor
                                )
                                if (module != modules.get(0)) {
                                    ...
                                    RenderUtils.drawRect(
                                        xPos - 1 - backgroundwidth.get() - (fontRenderer.getStringWidth(displayStrings) - fontRenderer.getStringWidth(
                                            displayString
                                        )), module.higt, xPos - 1 - backgroundwidth.get(), module.higt + 1,
                                        rectColor
                                    ) //功能左条和下条间隔
                                }
                                //最底边
