...
class GuiServerStatus(private val prevGui: IGuiScreen) : WrappedGuiScreen() {
    ...
    override fun initGui() {
        representedScreen.buttonList.add(
            classProvider.createGuiButton(
                ...
                representedScreen.height / 4 + 145,
                "Back"
            )
        )
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        RenderUtils.drawRect(
            ...
            i - 5.0f,
            representedScreen.width / 2.0f + 115,
            representedScreen.height / 4.0f + 43 + if (status.keys.isEmpty()) 10 else status.keys.size * Fonts.font40.fontHeight,
            Integer.MIN_VALUE
        )
        ...
        if (status.isEmpty()) {
            Fonts.font40.drawCenteredString(
                ...
                representedScreen.height / 4.0f + 40,
                Color.WHITE.rgb
            )
        } else {
