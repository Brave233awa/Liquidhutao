...
class GuiSessionLogin(private val prevGui: GuiAltManager) : WrappedGuiScreen() {
    ...
    override fun initGui() {
        ...
        loginButton = classProvider.createGuiButton(
            1,
        ...
        sessionTokenField =
            classProvider.createGuiTextField(666, Fonts.font40, representedScreen.width / 2 - 100, 80, 200, 20)
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        Fonts.font35.drawCenteredString(
            ...
            representedScreen.height / 4.0f + 80.0f,
            0xffffff
        )
