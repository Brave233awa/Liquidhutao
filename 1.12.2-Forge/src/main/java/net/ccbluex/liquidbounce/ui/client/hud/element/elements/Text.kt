    ...
    override fun drawElement(): Border? {
        ...
        if (this.rect.get())
            RenderUtils.drawRect(
                -2f,
                -2f,
                (fontRenderer.getStringWidth(displayText) + 1).toFloat(),
                fontRenderer.fontHeight.toFloat(),
                Color(0, 0, 0, 150).rgb
            )
        fontRenderer.drawString(
            displayText, 0F, 0F, if (rainbow.get())
        ...
        if (this.op.get()) {
            ...
            RenderUtils.drawGradientSideways(
                -3.0, -7.0, (fontRenderer.getStringWidth(displayText) + 2.0).toDouble(), -3.0, if (rainbow.get())
        ...
        if (this.sk.get()) {
            UiUtils.drawRect(
                ...
                fontRenderer.fontHeight.toDouble() + 6,
                Color(0, 0, 0).rgb
            )
            UiUtils.outlineRect(
                -10.0,
                ...
                fontRenderer.fontHeight.toDouble() + 5,
                8.0,
                Color(59, 59, 59).rgb,
                Color(59, 59, 59).rgb
            )
            UiUtils.outlineRect(
                -9.0,
                -7.5,
                (fontRenderer.getStringWidth(displayText) + 7).toDouble(),
                fontRenderer.fontHeight.toDouble() + 4,
                4.0,
                Color(59, 59, 59).rgb,
                Color(40, 40, 40).rgb
            )
            UiUtils.outlineRect(
                ...
                fontRenderer.fontHeight.toDouble() + 0,
                1.0,
                Color(18, 18, 18).rgb,
                Color(0, 0, 0).rgb
            )
        ...
        if (this.outline.get()) {
            ...
            RenderUtils.drawOutlinedString(
                info,
