...
class GuiMainMenu : WrappedGuiScreen() {
    ...
    override fun initGui() {
        ...
        representedScreen.buttonList.add(
            classProvider.createGuiButton(
                ...
                98,
                20,
                functions.formatI18n("menu.singleplayer")
            )
        )
        representedScreen.buttonList.add(
            classProvider.createGuiButton(
                ...
                98,
                20,
                functions.formatI18n("menu.multiplayer")
            )
        )
        ...
        representedScreen.buttonList.add(
            classProvider.createGuiButton(
                ...
                98,
                20,
                functions.formatI18n("menu.options")
            )
        )
        representedScreen.buttonList.add(
            classProvider.createGuiButton(
                ...
                98,
                20,
                functions.formatI18n("menu.quit")
            )
        )
    }
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        RenderUtils.drawRect(
            representedScreen.width / 2.0f - 115,
            representedScreen.height / 4.0f + 35,
            representedScreen.width / 2.0f + 115,
            representedScreen.height / 4.0f + 175,
            Integer.MIN_VALUE
        )
        ...
        Fonts.fontBold180.drawCenteredString(
            ...
            representedScreen.height / 8F,
            4673984,
            true
        )
        Fonts.font35.drawCenteredString(
            "b" + LiquidBounce.CLIENT_VERSION,
            representedScreen.width / 2F + 148,
            representedScreen.height / 8F + Fonts.font35.fontHeight,
            0xffffff,
            true
        )
